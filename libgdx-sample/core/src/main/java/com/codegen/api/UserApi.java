...
public interface UserApi {
    void entitiesUserEntityIdDelete(
            String entityId
        ,
        Callback<Void> callback
    );
    void entitiesUserEntityIdGet(
            String entityId
    ...
    void entitiesUserEntityIdPut(
            String entityId
                    EntityUser entityUser
        ,
        Callback<EntityUser> callback
    );
    void entitiesUserGet(
            Boolean returnCount
                    String offset
                    String limit
                    String sort
    ...
    void entitiesUserPost(
            EntityUser entityUser
        ,
        Callback<EntityUser> callback
    );
    void entitiesUserSearchGet(
            String filter
                    Boolean returnCount
                    String offset
                    String limit
