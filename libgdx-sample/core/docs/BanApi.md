...
- **200**: Success. The entity is returned in the response body. — Returns `EntityBan`
...
- **200**: Success. The updated entity is returned in the response body. — Returns `EntityBan`
...
- **200**: Success. The list of entities is returned in the response body. — Returns `java.util.ArrayList&lt;EntityBan&gt;`
- **403**: Forbidden. The user doesn&#39;t have permissions to read the entity. — Returns `Error`
- **404**: Not found. MetaClass for the entity with the given name not found. — Returns `Error`
...
- **201**: Entity created. The created entity is returned in the response body. — Returns `EntityBan`
...
- **200**: Success. Entities that conforms filter conditions are returned in the response body. — Returns `java.util.ArrayList&lt;EntityBan&gt;`
